...
for quiz_num in range(35):
    # 問題集と回答集のファイルを作成する
    quiz_file = open(os.path.join(file_dir, 'capitalsquiz{}.txt'.format(quiz_num + 1)), 'w')
    answer_key_file = open(os.path.join(file_dir, 'capitalsquiz_answers{}.txt'.format(quiz_num + 1)), 'w')
